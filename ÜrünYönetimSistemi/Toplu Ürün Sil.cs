...
namespace ÜrünYönetimSistemi
{
    public partial class Toplu_Ürün_Sil : Form
    {
        ...
        private void Toplu_Ürün_Sil_Load(object sender, EventArgs e)
        {
            ...
            // Satır taşıma metodu için event'leri ekle
        ...
        // Satır tıklayınca taşıma işlemi
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            // DataView'den satırı silmek yerine DataTable'dan orijinal satırı bulup silmek daha güvenli
        ...
        private async void button2_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Seçilen ürünler ve toptancı borçları güncellendi.", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
