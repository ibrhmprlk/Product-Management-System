...
namespace ÜrünYönetimSistemi
{
    public partial class Raporlar : Form
    {
        ...
        private void ToplamlariGuncelle()
        {
            ...
            if (checkBox1.Checked) textBox8.Text = (toplamGelir - toplamGider).ToString("N2", trCulture);
            else if (checkBox2.Checked && !checkBox3.Checked && !checkBox4.Checked && !checkBox5.Checked) textBox8.Text = toplamGelir.ToString("N2", trCulture);
            else if (checkBox3.Checked && !checkBox2.Checked && !checkBox4.Checked && !checkBox5.Checked) textBox8.Text = toplamGider.ToString("N2", trCulture);
            else textBox8.Text = (toplamGelir - toplamGider).ToString("N2", trCulture);
